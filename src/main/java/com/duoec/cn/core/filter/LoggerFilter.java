package com.duoec.cn.core.filter;
...
import com.duoec.cn.core.common.utils.HttpServletRequestUtils;
...
public class LoggerFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        BufferedWrapperResponse bufferedResponse = new BufferedWrapperResponse(httpServletResponse);
