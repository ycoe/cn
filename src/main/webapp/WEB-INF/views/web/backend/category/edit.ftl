                    ...
                    <div class="smart-widget-body">
                        <#list LANGUAGES as language>
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" data-parsley-required="true" name="names[${language.id}]" value="${category???string(category.names[language.id], '')}" />
                                </div>
                            </div>
                        </#list>
                    </div>
                ...
                <div class="smart-widget-inner">
                    <div class="smart-widget-body">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" data-parsley-type="integer" name="sort" placeholder="请使用整数，越小越前，默认为255" value="${category???string(category.sort, '')}"/>
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="smart-widget-inner">
                    <div class="smart-widget-body">
                        ...
                        <div class="text-right m-t-20">
                            <input type="hidden" name="id" value="${category???string(category.id, '')}" />
