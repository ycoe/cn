...
import com.duoec.web.core.SpringContextHolder;
import com.duoec.web.core.freemarker.PortletRegistException;
import com.duoec.web.core.freemarker.method.FMethod;
...
import com.duoec.web.core.freemarker.portlet.PortletProxy;
...
public class FreeMarkerComponentRegist {
    ...
    private void scanFreemarkerExtends(String packagePattern) throws Exception {
        ...
        String ex = ResourcePatternResolver.CLASSPATH_ALL_URL_PREFIX + ClassUtils.convertClassNameToResourcePath(packagePattern);
