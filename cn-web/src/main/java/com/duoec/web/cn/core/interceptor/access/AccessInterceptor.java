package com.duoec.web.cn.core.interceptor.access;

import com.duoec.web.cn.core.common.CommonConst;
import com.duoec.web.core.freemarker.service.ICache;
import com.duoec.web.cn.core.common.exceptions.Http406Exception;
...
public class AccessInterceptor extends HandlerInterceptorAdapter {
    ...
    private String getSid(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (Strings.isNullOrEmpty(sid)) {
            ...
            //写入cookies
            CookieUtils.setCookie(response, domain, CommonConst.SSID, sid);
        }
        return sid;
    }
