    ...
    <div class="sidebar-inner scrollable-sidebar">
            ...
            <ul class="sidebar-list">
                <li>
                    <a href="#" class="clearfix">
                        <img src="${assetsUrl}/img/backend/profile/profile2.jpg" class="img-circle" alt="user avatar">
                ...
                <li>
                    <a href="#" class="clearfix">
                        <img src="${assetsUrl}/img/backend/profile/profile3.jpg" class="img-circle" alt="user avatar">
                        <div class="chat-detail m-left-sm">
                            <div class="chat-name">
                                Jane Doe
                            </div>
                ...
                <li>
                    <a href="#" class="clearfix">
                        <img src="${assetsUrl}/img/backend/profile/profile4.jpg" class="img-circle" alt="user avatar">
                        <div class="chat-detail m-left-sm">
                            <div class="chat-name">
                                John Doe
                            </div>
                ...
                <li>
                    <a href="#" class="clearfix">
                        <img src="${assetsUrl}/img/backend/profile/profile5.jpg" class="img-circle" alt="user avatar">
                        <div class="chat-detail m-left-sm">
                            <div class="chat-name">
                                John Doe
                            </div>
        ...
        <div class="content-block">
            <ul class="sidebar-list">
                <li>
                    <a href="#" class="clearfix">
                        <img src="${assetsUrl}/img/backend/profile/profile6.jpg" class="img-circle" alt="user avatar">
                        <div class="chat-detail m-left-sm">
                            <div class="chat-name">
                                John Doe
                            </div>
                ...
                <li>
                    <a href="#" class="clearfix">
                        <img src="${assetsUrl}/img/backend/profile/profile7.jpg" class="img-circle" alt="user avatar">
                        <div class="chat-detail m-left-sm">
                            <div class="chat-name">
                                Jane Doe
                            </div>
                ...
                <li>
                    <a href="#" class="clearfix">
                        <img src="${assetsUrl}/img/backend/profile/profile8.jpg" class="img-circle" alt="user avatar">
                        <div class="chat-detail m-left-sm">
                            <div class="chat-name">
                                John Doe
                            </div>
                ...
                <li>
                    <a href="#" class="clearfix">
                        <img src="${assetsUrl}/img/backend/profile/profile9.jpg" class="img-circle" alt="user avatar">
                        <div class="chat-detail m-left-sm">
                            <div class="chat-name">
                                John Doe
                            </div>
