...
var ImageUpload = /** @class */ (function () {
    ...
    ImageUpload.prototype.initUploadInput = function () {
    };
    ImageUpload.prototype.initUploadButton = function () {
        var uploaderId = this.id;
        var uploader = WebUploader.create({
            server: 'https://up-z0.qiniup.com',
            formData: {
                token: uploadToken,
                key: 'upload2/' + Math.random().toString().substr(3) + '.jpg'
            },
            pick: {
        ...
        uploader.on('uploadSuccess', function (file, response) {
            ...
            var url = 'http://assets.duoec.com/' + response.key;
